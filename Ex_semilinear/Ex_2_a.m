...
function Ex_2_a(coarse_solver, fine_solver, TN, J, ep)

tic;
L=pi;       % inteval x \in [0, L];
M0=500;    % count of sub-intervals of space
r=1;        % order on space
T = 1;      % t \in [0, T];
...
saveas(gcf,['Ex_2_a_data/figure plot/',folder_name,'/J_',num2str(J),'_',coarse_solver_name,'_',fine_solver_name,'.png']);
save(['Ex_2_a_data/figure data/',folder_name,'/J_',num2str(J),'_',coarse_solver_name,'_',fine_solver_name,'.mat'],'err');
