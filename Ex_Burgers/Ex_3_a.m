function Ex_3_a(coarse_solver, fine_solver, J, Nt_fine,nu, Nx)
...
saveas(gcf,['Ex_3_a_data/figure plot/',folder_name,'/J_',num2str(J),'_',coarse_solver_name,'_',fine_solver_name,'.png']);
save(['Ex_3_a_data/figure data/',folder_name,'/J_',num2str(J),'_',coarse_solver_name,'_',fine_solver_name,'.mat'],'err');
