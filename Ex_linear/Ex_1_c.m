% Example 4.1, problem data (c):
% T = 100, u0 = 2\chi_{(0,\pi/2)}(x)-1, f = 50sin(2pi(x+t));
% Table 4.2
...
T = 100;     % t \in [0, T];
tn = 4500;  % count of sub-intervals of time
% change tn to achieve the target efficiency 1e-7
% tn = 15000; % three-stage Lobatto
% tn = 4500;  % three-stage Radau
% tn = 3000;  % four-stage Lobatto
...
%% Table 4.2
Exact_time = 6295; % for three-stage Lobatto
% Exact time test for different scheme
% Exact_time = 1868; % for three-stage Radau
% Exact_time = 2504; % for four-stage Lobatto
